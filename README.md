...
| File | Description |
|------|-------------|
| [`intune/rdp-signing/`](intune/rdp-signing/) | End-to-end fix for the April 2026 Windows update "Unknown Publisher" RDP warning — self-signed cert + Intune Trusted Certificate profile + Settings Catalog + Win32 package |
...
- All files use **placeholder values** for tenant-specific information. Search and replace before deploying:
  ...
  - `YOURORG` → Your organization short name (used in the RDP signing templates)
